...
import com.demanganesia.explorepurworejo.Database.UserHelperClass;
...
public class VerifikasiDaftarActivity extends AppCompatActivity {
    ...
    PinView kodePin;
    String codeBySystem;
    String namaLengkap, username, email, kataSandi, tanggalLahir, jenisKelamin, nomorTelefon;
    ...
    private void verifikasiKodePin(String code) {
        PhoneAuthCredential credential = PhoneAuthProvider.getCredential(codeBySystem,code);
        masukDenganKode(credential);
    }

    private void masukDenganKode(PhoneAuthCredential credential) {
